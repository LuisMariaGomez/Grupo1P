...
namespace API.Controllers
{
    ...
    public class TipoDocumentoController : ControllerBase
    {
        ...
        {
            var queryable = _context.TipoDocumento.AsQueryable().Where(x => x.Nombre.Contains(nombre));
        ...
        {
            TipoDocumento TipoDocumentoEntity = new TipoDocumento { Nombre = TipoDocumento.Nombre, };
        ...
        {
            TipoDocumento TipoDocumentoEntity = new TipoDocumento { Id = id, Nombre = TipoDocumento.Nombre, };
