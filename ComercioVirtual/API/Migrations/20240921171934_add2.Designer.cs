            ...
            modelBuilder.Entity("Shared.Entities.Personas", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 14, 19, 33, 124, DateTimeKind.Local).AddTicks(7296));
            ...
            modelBuilder.Entity("Shared.Entities.Productos", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 14, 19, 33, 124, DateTimeKind.Local).AddTicks(7935));
            ...
            modelBuilder.Entity("Shared.Entities.TipoDocumento", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 21, 14, 19, 33, 124, DateTimeKind.Local).AddTicks(8421));
