            ...
            modelBuilder.Entity("Shared.Entities.Estados", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 22, 14, 58, 33, 352, DateTimeKind.Local).AddTicks(2705));
            ...
            modelBuilder.Entity("Shared.Entities.Personas", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 22, 14, 58, 33, 352, DateTimeKind.Local).AddTicks(1212));
            ...
            modelBuilder.Entity("Shared.Entities.Productos", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 22, 14, 58, 33, 352, DateTimeKind.Local).AddTicks(1883));
            ...
            modelBuilder.Entity("Shared.Entities.TipoDocumento", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 22, 14, 58, 33, 352, DateTimeKind.Local).AddTicks(2275));
